...
#include <mc/src-client/common/client/gui/controls/ToggleComponent.hpp>
#include <mc/src-client/common/client/gui/controls/SliderComponent.hpp>
#include <mc/src-client/common/client/gui/controls/TextComponent.hpp>
