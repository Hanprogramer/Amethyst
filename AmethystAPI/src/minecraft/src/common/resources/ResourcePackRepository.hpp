...
public:
    ...
    MINECRAFT void _initializePackSource();
...
struct Pack {
    ...
    MINECRAFT void addFromUUID(const PackIdVersion& version);
};
} // namespace lambda