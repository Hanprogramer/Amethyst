...
#include <minecraft/src/common/world/level/storage/LevelData.hpp>
#include <minecraft/src/common/world/level/storage/Experiments.hpp>
#include <minecraft/src/common/GameVersion.hpp>
#include <minecraft/src-deps/core/resource/ContentIdentity.hpp>
