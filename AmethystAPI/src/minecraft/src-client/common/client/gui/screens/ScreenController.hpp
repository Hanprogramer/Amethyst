...
public:
    ...
    void registerButtonInteractedHandler(uint32_t id, std::function<ui::ViewRequest(UiPropertyBag*)> callback);

    /// @signature {48 89 5C 24 ? 48 89 6C 24 ? 48 89 74 24 ? 57 41 54 41 55 41 56 41 57 48 83 EC ? 48 8B 05 ? ? ? ? 48 33 C4 48 89 44 24 ? 0F 10 52}
    ui::ViewRequest _handleButtonEvent(ScreenEvent& event);
};