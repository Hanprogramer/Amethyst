...
public:
    ...
    /// @vidx {3}
    virtual ui::ViewRequest handleEvent(ScreenEvent& event);
    /// @vidx {4}
    virtual std::optional<std::string> getRoute();
    /// @vidx {5}
    virtual void setScreenState(const std::vector<std::pair<std::string_view, std::string_view>>& state);
    /// @vidx {6}
